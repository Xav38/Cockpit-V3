    ...
    >
      ...
      >
        ...
        <MenuSection label={dictionary['navigation'].appsPages}>
          ...
          <SubMenu label={dictionary['navigation'].projets} icon={<i className='ri-folder-line' />}>
            <MenuItem href={`/${locale}/apps/projets/list`}>{dictionary['navigation'].list}</MenuItem>
            <MenuItem href={`/${locale}/apps/projets/attributions`}>{dictionary['navigation'].attributions}</MenuItem>
          </SubMenu>
